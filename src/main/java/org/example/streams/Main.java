...
public class Main {
    public static void main(String[] args) {
        ...
        // Parallel stream
        numbers.parallelStream().forEachOrdered(n -> System.out.println(n + " " + Thread.currentThread().getName()));
        ...
        users.stream().filter(userPredicate).forEach(user -> System.out.println(user.getName() + "_users"));
        ...
        System.out.println(intStream.max() + "__57");
        ...
        System.out.println(FilterAndModifyLettersMap.filterLetters("6el1oWir3d") + " __78");
        // Print the resulting map
        resultMap.forEach((key, value) -> System.out.println(key + " -> " + value + " __resultmap"));
        ...
        System.out.println(convertAndModifyNumbers(i112) + "____94");
